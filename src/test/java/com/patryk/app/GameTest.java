...
public class GameTest {
    ...
    @Test
    public void automaticTest() throws FileNotFoundException {
    ...
    @Test
    public void automaticBanInputTest() throws FileNotFoundException {
    ...
    private static void generateAllCombinationsOnGivenBoard ( int rows, int columns,
                                                              int winningCondition,
                                                              AutomaticTestsLogic automaticTestsLogic) throws FileNotFoundException {
